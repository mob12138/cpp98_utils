/**
 * @file thread.hpp
 * @brief C++98 windows线程类
 * @author zhengw
 * @date 2024-07-03
 */

#ifndef THREAD_WIN_HPP
#define THREAD_WIN_HPP
...
public:
    thread(BOOL v_bSuspend = FALSE)
        : m_hThread(NULL), m_uiThreadId(0), m_iPriority(THREAD_PRIORITY_NORMAL), m_bRunning(FALSE)
    {
...
public:
    ...
    BOOL create()
    {
        ...
        m_hThread = (HANDLE)::_beginthreadex(NULL, 0, thread_func, this, CREATE_SUSPENDED, &m_uiThreadId);
...
private:
     ...
     * @return
     */
    static UINT WINAPI thread_func(LPVOID v_lpParam)
    {
